...
- **figures_and_analyses.R** — R script to reproduce the figures and statistical analyses reported in the paper using the `results.csv` output from the simulations.

- **Results_2025.csv** — CSV file with data generated by the model
